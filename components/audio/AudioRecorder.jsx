    ...
    async (id) => {
      try {
        ...
        tx.oncomplete = () => {
          ...
          showPopup("Deleted recording", "success");
  ...
  <br />
   <div onLoad={() => setDarkMode(!darkMode)}  className='main-title'>
       <Link onClick={() => navigate(-1)}  class="btn btn-succes ml-3 mt-2 pb-1 new-account-ticket float-start">
             ...
             <br />
              <div className='mt-3'>
            <h4 class="text-gray-500 float-end mr-4">Record Audio</h4>
      ...
      <div className="max-w-md mx-auto text-center">
        ...
        {!isRecording ? (
          <button
            ...
            className="bg-green-600 text-white px-4 py-2 rounded-full shadow btn btn-primary btn-user btn-bloc BR15 transparent"
          >
            🎙️ Start Recording
          </button>
        ) : (
          <button
            ...
            className="bg-red-600 text-white px-4 py-2 rounded-full shadow btn btn-primary btn-user btn-bloc BR15 transparent"
          >
            ⏹️ Stop Recording
          </button>
        )}
        ...
        <button onClick={uploadAllAudio} className="mt-3 text-blue-500 underline btn btn-primary btn-user btn-bloc R15 transparent">
          Upload All Pending
        </button>
