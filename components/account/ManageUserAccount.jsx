 ...
 <div className='sidebar-title '>
        ...
        <ul className='sidebar-list'>
            <li onClick={() => {navigate('/pnlat/mail')}}
                ...
                <Link to="">
                Name<span className='small ML6 float-ends'>Panashe Brandon</span><FaAngleRight className=' float-end'/>
                </Link>
            </li>
            {/* <li onClick={() => {navigate('')}}
                className='sidebar-list-item btn-effe'>
                <Link >
                Member Level<span className='small ML6 MEMBERSHIPLVL float-en'>Free</span>
                </Link>
            </li> */}
