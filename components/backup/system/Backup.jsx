...
import { FaAngleLeft, FaFileCsv } from 'react-icons/fa';
...
const Backup = () => {
  ...
  const columns = [
      ...
      {
          name: 'Options',
          cell: row => <Link to={`/dfms/entities/user/staff/staff breed read/${row.breed_id}`}>more..</Link>,
      },
  ];
  ...
  return (
    <>
        ...
        <div className='container-fluid'>
           <br />
          <Link to='/dfms/entities/user/staff/dashboard' className='btn btn-success'><FaAngleLeft /> Back </Link>
                
           <Link to="/export" class="btn btn-success float-end"><FaFileCsv /> Export </Link>
                <br /><br />
